...
//      case ("AppBar", "onTitleTouchTap")              => TouchTapEventHandler
      ...
      case ("IconMenu", "onItemTouchTap")             => "(ReactTouchEvent, React.Element) => Callback"
      case ("IconMenu", "onItemClick")                => "(ReactEvent, React.Element) => Callback"
...
//      case ("Snackbar", "onActionTouchTap")           => TouchEventHandler
      ...
      case ("Stepper", "updateCompletedStatus")       => "(Int, React.Node) => CallbackTo[Boolean]"
      ...
      case ("Tab", "onActive")                        => "React.Element => Callback"
      case ("Tabs", "onChange")                       => "(T, ReactEventFromHtml, React.Element) => Callback"
