...
object Mui {
  ...
  @js.native @JSImport("material-ui/Card/CardTitle", JSImport.Default) object CardTitle
      extends js.Any
  @js.native @JSImport("material-ui/Card/CardText", JSImport.Default) object CardText
      extends js.Any
  ...
  @js.native @JSImport("material-ui/List/ListItem", JSImport.Default) object ListItem
      extends js.Any
