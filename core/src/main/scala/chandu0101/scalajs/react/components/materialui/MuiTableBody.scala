...
case class MuiTableBody(
	...
	onCellHoverExit:     js.UndefOr[ReactEvent => Callback]   = js.undefined,
	onCellClick:         js.UndefOr[ReactEvent => Callback]   = js.undefined,
	onRowHover:          js.UndefOr[ReactEvent => Callback]   = js.undefined,
	onRowSelection:      js.UndefOr[ReactEvent => Callback]   = js.undefined,
	onRowHoverExit:      js.UndefOr[ReactEvent => Callback]   = js.undefined,
	onCellHover:         js.UndefOr[ReactEvent => Callback]   = js.undefined)
{
