...
case class MuiListItem(
  ...
  /* default: false: If true, the list-item will not be clickable and will not display hover affects.
This is automatically disabled if leftCheckbox or rightToggle is set.*/
  ...
  /* default: false: If true, the children will be indented by 72px.
...
This property is automatically managed so modify at your own risk.*/
  ...
  /* default: false: If provided, tapping on the primary text of the item toggles the nested list.*/
