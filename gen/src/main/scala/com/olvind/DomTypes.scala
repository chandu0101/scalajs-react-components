  ...
  override val props = super.props ++
    Seq(
      ...
      ParsedProp(
        ...
        commentOpt = Some(
          PropComment("Specifies whether an <input> element should have autocomplete enabled"))
      ),
      ParsedProp(
        PropName("autofocus"),
      ...
      ParsedProp(PropName("form"),
                 baseType = Normal("String"),
                 commentOpt = Some(
                   PropComment("Specifies one or more forms the <input> element belongs to"))),
      ParsedProp(
        PropName("formaction"),
        baseType = Normal("String"),
        commentOpt = Some(PropComment(
