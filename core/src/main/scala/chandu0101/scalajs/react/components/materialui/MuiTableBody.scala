...
CTRL/CMD+Click and SHIFT+Click are valid actions. The default value is false.*/
  ...
  /* default: true: Controls whether or not the rows are pre-scanned to determine initial state.
