...
/**
  ...
  */
case class MuiTable(key: js.UndefOr[String] = js.undefined,
  ...
  def apply(children: VdomNode*) = {
    ...
    val component = JsComponent[js.Object, Children.Varargs, Null](Mui.Table)
    component(props)(children: _*)
  }
}
@js.native
class MuiTableM extends js.Object {
  def createTableBody(base: js.Any): js.Dynamic = js.native

  def createTableFooter(base: js.Any): js.Dynamic = js.native

  def createTableHeader(base: js.Any): js.Dynamic = js.native

  def isScrollbarVisible(): js.Dynamic = js.native
}
